...
### 1.1. Прежде чем приступить к настройке uWSGI
...
Тем временем вы можете попробовать посмотреть на вывод uwsgi по адресу http://example.com:8001 - но, скорее всего, это не сработает, потому что ваш браузер говорит на http, а не на uWSGI, хотя вы должны увидеть вывод uWSGI в терминале.
...
Попробуйте зайти на http://example.com:8000/ в браузере.
...
### Настройка uWSGI на запуск с помощью .ini файла
...
###  Установите uWSGI на всю систему
...
### Создание файла юнитов systemd для uWSGI
